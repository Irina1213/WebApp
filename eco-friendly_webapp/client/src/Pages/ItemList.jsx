          ...
          <div className="itemList">
            ...
            {currentItems.length === 0 && (
              <div className="noCatItems">
                <img src={NO} alt="Product Not Found" width="600" />
              </div>
            )}
        ...
        <div>
          <div className="addBtn">
            ...
            <div className="colorInfo">
              <p className="colInfo">
                <span className="redDa">Red </span> - Expired/Expiration date within 3
                days
              </p>
              <p className="colInfo">
                <span className="orangeDa">Orange </span> - Expiration date within 2
                weeks
              </p>
              <p className="colInfo">
                <span className="yellowDa">Yellow </span> - Expiration date within a
                month
              </p>
              <p className="colInfo">
